...
const collection = (name) => {
  ...
  return {
    async getList(page = 1, pageSize = 20, options = {}) {
      ...
      return { items, page: payload.page, perPage: payload.page_size, totalItems: payload.total, totalPages: payload.__from_cache ? payload.page : payload.total_pages, offline: Boolean(payload.__from_cache) };
    },
